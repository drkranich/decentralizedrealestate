// Legacy fallback data kept for UI development references.
...
export const properties: Property[] = [
  {
    ...
    built: 2022,
    description:
      "A meticulously designed loft in Lisbon's most iconic neighborhood. Floor-to-ceiling windows, custom oak interiors, full smart-home integration.",
    gradient: "emerald/40",
  },
  {
    id: "2",
    name: "Skyline Tower 22F",
    city: "Tokyo",
    country: "Japan",
    ...
    built: 2020,
    description:
      "High-rise apartment with panoramic Tokyo skyline views. Premium concierge and rooftop access.",
    gradient: "skyblue/40",
  },
  {
    id: "3",
    name: "Beach Villa Kuta",
    city: "Bali",
    country: "Indonesia",
