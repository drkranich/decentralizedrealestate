...
function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <SectionTitle title="Occupancy by property" action={<Link to="/admin/properties-analytics" className="text-xs font-medium text-emerald hover:underline">View all</Link>} />
          <div className="h-64">
            <ResponsiveContainer>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <SectionTitle
            title="ROI analytics"
            action={<Link to="/admin/finance" className="text-xs font-medium text-emerald hover:underline">Open finance</Link>}
          />
          <div className="h-56">
            <ResponsiveContainer>
        ...
        <Card>
          <SectionTitle title="Smart pricing" action={<Link to="/admin/smart-pricing" className="text-xs font-medium text-emerald hover:underline">Tune</Link>} />
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <Card>
          <SectionTitle
            ...
            action={<Link to="/admin/marketplace" className="text-xs font-medium text-emerald hover:underline">Browse</Link>}
          />
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-3">
        {[
          { label: "Outstanding payments", value: "€8,420", note: "3 overdue", color: "warn" as const, to: "/admin/finance" },
          { label: "Pending contracts", value: "7", note: "2 awaiting signature", color: "blue" as const, to: "/admin/contracts" },
          { label: "Active tenants", value: "148", note: "+12 this month", color: "emerald" as const, to: "/admin/crm" },
        ].map((q) => (
          <Card key={q.label}>
            <div className="flex items-center justify-between">
