    ...
    <SidebarProvider>
      <div className="relative flex min-h-screen w-full overflow-hidden bg-secondary/30">
        ...
        <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute right-[-10rem] top-1/3 h-[24rem] w-[24rem] rounded-full bg-gold/15 blur-[110px] animate-drift-slower" />
        ...
        <div className="relative z-10 flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-white/10 bg-background/70 px-4 backdrop-blur-xl md:px-6">
            ...
            <button className="hidden items-center gap-2 rounded-full bg-gradient-to-r from-emerald to-emerald-glow px-4 py-2 text-sm font-medium text-white shadow-glow transition-transform hover:scale-105 md:flex">
